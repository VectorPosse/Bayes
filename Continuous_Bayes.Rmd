---
title: "Bayes's Theorem for continuous distributions"
...
The code below defines the binomial likelihood function for 12 successes in a sample of size 18. (Note that in R, probability density functions start with `d`, like `dbinom` or `dnorm`.)
